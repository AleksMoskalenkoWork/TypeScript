...
class FormProcessorRefactored<
  T extends Record<string, unknown> = Record<string, unknown>,
  /// не впевнений але здається unknown більш безпечний ніж any. кращого рішення не придумав. доречі після знайомства з unknown почав використовувати його в коді замість any. стало трохи легше.
> {
  public data: T;
  ...
  // якщо правильно розумію, то реалізація схожа на перше завдання
